...
public class CursedTreeData
{

    // list of vector 2 ints for the tree positions
    public List<Vector2Int> cursedTreePositions = new List<Vector2Int>();

    // list of vector 3 ints for the solid tree leaves
    public List<Vector3Int> cursedTreeLeavesSolid = new List<Vector3Int>();
