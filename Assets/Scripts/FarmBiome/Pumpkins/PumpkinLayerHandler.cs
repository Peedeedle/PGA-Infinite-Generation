...
public class PumpkinLayerHandler : BlockLayerHandler
{
    ...
    protected override bool TryHandling(ChunkData chunkData, int x, int y, int z, int surfaceHeightNoise, Vector2Int mapSeedOffset) {
        ...
        if (surfaceHeightNoise < terrainHeightLimit && chunkData.pumpkinData.pumpkinPositions.Contains(new Vector2Int(chunkData.worldPosition.x + x, chunkData.worldPosition.z + z))) {
            ...
            if (type == BlockType.TilledSoil) {
                ...
                // set the block of the local position to tilled soil
                Chunk.SetBlock(chunkData, chunkCoordinates, BlockType.TilledSoil);
                ...
                for (int i = 1; i < 2; i++) {
                    ...
                    // create a pumpkin
                    Chunk.SetBlock(chunkData, chunkCoordinates, BlockType.Pumpkin);
