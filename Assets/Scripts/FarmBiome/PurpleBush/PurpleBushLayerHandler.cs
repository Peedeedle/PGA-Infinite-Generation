////////////////////////////////////////////////////////////
// File: PurpleBushLayerHandler.cs
// Author: Jack Peedle
...
public class PurpleBushLayerHandler : BlockLayerHandler
{
    ...
    protected override bool TryHandling(ChunkData chunkData, int x, int y, int z, int surfaceHeightNoise, Vector2Int mapSeedOffset) {
        ...
        if (surfaceHeightNoise < terrainHeightLimit && chunkData.purpleBushData.purpleBushPositions.Contains(new Vector2Int(chunkData.worldPosition.x + x, chunkData.worldPosition.z + z))) {
            ...
            if (type == BlockType.TilledSoil) {
                ...
                for (int i = 1; i < 2; i++) {
                    ...
                    // create a purple bush
                    Chunk.SetBlock(chunkData, chunkCoordinates, BlockType.PurpleBush);
