...
public class RedBushLayerHandler : BlockLayerHandler
{
    ...
    protected override bool TryHandling(ChunkData chunkData, int x, int y, int z, int surfaceHeightNoise, Vector2Int mapSeedOffset) {
        ...
        if (surfaceHeightNoise < terrainHeightLimit && chunkData.redBushData.redBushPositions.Contains(new Vector2Int(chunkData.worldPosition.x + x, chunkData.worldPosition.z + z))) {
            ...
            if (type == BlockType.TilledSoil) {
                ...
                for (int i = 1; i < 2; i++) {
                    ...
                    // create a red bush
                    Chunk.SetBlock(chunkData, chunkCoordinates, BlockType.RedBush);
