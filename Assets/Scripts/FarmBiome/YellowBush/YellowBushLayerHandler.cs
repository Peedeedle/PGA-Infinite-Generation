////////////////////////////////////////////////////////////
// File: YellowBushLayerHandler.cs
// Author: Jack Peedle
...
public class YellowBushLayerHandler : BlockLayerHandler
{
    ...
    protected override bool TryHandling(ChunkData chunkData, int x, int y, int z, int surfaceHeightNoise, Vector2Int mapSeedOffset) {
        ...
        if (surfaceHeightNoise < terrainHeightLimit && chunkData.yellowBushData.yellowBushPositions.Contains(new Vector2Int(chunkData.worldPosition.x + x, chunkData.worldPosition.z + z))) {
            ...
            if (type == BlockType.TilledSoil) {
                ...
                for (int i = 1; i < 2; i++) {
                    ...
                    // create a yellow bush
                    Chunk.SetBlock(chunkData, chunkCoordinates, BlockType.YellowBush);
