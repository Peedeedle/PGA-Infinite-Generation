////////////////////////////////////////////////////////////
// File: OrangeCubeLayerHandler.cs
// Author: Jack Peedle
...
public class OrangeCubeLayerHandler : BlockLayerHandler
{
    ...
    protected override bool TryHandling(ChunkData chunkData, int x, int y, int z, int surfaceHeightNoise, Vector2Int mapSeedOffset) {
        ...
        if (surfaceHeightNoise < terrainHeightLimit && chunkData.orangeCubeData.orangeCubePositions.Contains(new Vector2Int(chunkData.worldPosition.x + x, chunkData.worldPosition.z + z))) {
            ...
            if (type == BlockType.CandyGrass) {
                ...
                for (int i = 1; i < 2; i++) {
                    ...
                    // create a orange cube
                    Chunk.SetBlock(chunkData, chunkCoordinates, BlockType.OrangeCube);
