////////////////////////////////////////////////////////////
// File: PineappleCubeLayerHandler.cs
// Author: Jack Peedle
...
public class PineappleCubeLayerHandler : BlockLayerHandler
{
    ...
    protected override bool TryHandling(ChunkData chunkData, int x, int y, int z, int surfaceHeightNoise, Vector2Int mapSeedOffset) {
        ...
        if (surfaceHeightNoise < terrainHeightLimit && chunkData.pineappleCubeData.pineappleCubePositions.Contains(new Vector2Int(chunkData.worldPosition.x + x, chunkData.worldPosition.z + z))) {
            ...
            if (type == BlockType.CandyGrass) {
                ...
                for (int i = 1; i < 2; i++) {
                    ...
                    // create a pineapple cube
                    Chunk.SetBlock(chunkData, chunkCoordinates, BlockType.PineappleCube);
