...
public class GreenCaneLayerHandler : BlockLayerHandler
{
    ...
    protected override bool TryHandling(ChunkData chunkData, int x, int y, int z, int surfaceHeightNoise, Vector2Int mapSeedOffset) {
        ...
        if (surfaceHeightNoise < terrainHeightLimit && chunkData.greenCaneData.greenCanePositions.Contains(new Vector2Int(chunkData.worldPosition.x + x, chunkData.worldPosition.z + z))) {
            ...
            if (type == BlockType.CandyGrass) {
                ...
                for (int i = 1; i < 5; i++) {
                    ...
                    // create a green cane
                    Chunk.SetBlock(chunkData, chunkCoordinates, BlockType.GreenCane);
