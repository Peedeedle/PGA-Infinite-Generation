...
public class SnowTreeLayerHandler : BlockLayerHandler
{
    ...
    public static List<Vector3Int> snowTreeLeaves = new List<Vector3Int>() {
    ...
    protected override bool TryHandling(ChunkData chunkData, int x, int y, int z, int surfaceHeightNoise, Vector2Int mapSeedOffset) {
        ...
        if (surfaceHeightNoise < terrainHeightLimit && chunkData.snowTreeData.snowTreePositions.Contains(new Vector2Int(chunkData.worldPosition.x + x, chunkData.worldPosition.z + z))) {
