...
public class CactusLayerHandler : BlockLayerHandler
{
    ...
    protected override bool TryHandling(ChunkData chunkData, int x, int y, int z, int surfaceHeightNoise, Vector2Int mapSeedOffset) {
        ...
        if (surfaceHeightNoise < terrainHeightLimit && chunkData.cactusData.cactusPositions.Contains(new Vector2Int(chunkData.worldPosition.x + x, chunkData.worldPosition.z + z))) {
