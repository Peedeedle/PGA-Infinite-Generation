...
public class SugarCaneLayerHandler : BlockLayerHandler
{
    ...
    protected override bool TryHandling(ChunkData chunkData, int x, int y, int z, int surfaceHeightNoise, Vector2Int mapSeedOffset) {
        ...
        if (surfaceHeightNoise < terrainHeightLimit && chunkData.sugarCaneData.sugarCanePositions.Contains(new Vector2Int(chunkData.worldPosition.x + x, chunkData.worldPosition.z + z))) {
            ...
            if (type == BlockType.JungleGrass) {
                ...
                Chunk.SetBlock(chunkData, chunkCoordinates, BlockType.JungleGrass);
                ...
                for (int i = 1; i < 5; i++) {
                    ...
                    // create a tree log
                    Chunk.SetBlock(chunkData, chunkCoordinates, BlockType.SugarCane);
